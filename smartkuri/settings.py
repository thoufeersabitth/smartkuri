...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # ✅ Corrected Path for your Chitti App
                'chitti.context_processors.group_admin_notifications',
            ],
        },
    },
]
...
# Use WhiteNoise storage for production (gzip + caching)
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "smartkuri.exception_handler.custom_exception_handler",
}
